...
public class UserController implements WebMvcConfigurer {
    ...
    public void addViewControllers(ViewControllerRegistry registry) {
        ...
        registry.addViewController("/teacher-info-view").setViewName("/teacher/teacher-info-view");
        registry.addViewController("/teacher-info-update").setViewName("/teacher/teacher-info-update");
